...
{
    public class MockTaskWithResource:UserTask
    {
        public MockTaskWithResource(string name, int priority, int degreeOfParallelism) : base(name, priority, degreeOfParallelism)
        {
        }

        public MockTaskWithResource(string name, int priority, int degreeOfParallelism, long cancellationTimeout) : base(name, priority, degreeOfParallelism, cancellationTimeout)
        {
        ...
        public MockTaskWithResource(string name, int priority, int degreeOfParallelism, long cancellationTimeout, DateTime deadline) : base(name, priority, degreeOfParallelism, cancellationTimeout, deadline)
        {
