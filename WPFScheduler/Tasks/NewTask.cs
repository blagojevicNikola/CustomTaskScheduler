...
namespace WPFScheduler.Tasks
{
    public class NewTask : UserTask
    {
        ...
        public NewTask(string name, int priority, int degreeOfParallelism, long cancellationTimeout) : base(name, priority, degreeOfParallelism, cancellationTimeout)
        {

        }

        public NewTask(string name, int priority, int degreeOfParallelism, DateTime deadline) : base(name,priority,degreeOfParallelism,degreeOfParallelism)
        {

        }

        public NewTask(string name, int priority, int degreeOfParallelism, long cancellationTimeout, DateTime deadline) : base(name, priority, degreeOfParallelism, cancellationTimeout, deadline)
        {
